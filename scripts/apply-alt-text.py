...
The alt text below was generated by Claude Opus 5 (via Claude Code), which
viewed each image before describing it. Button text is transcribed verbatim so
it matches what sighted users see, and people are named from the surrounding
headings rather than identified from the picture. It has not been reviewed by
someone who knows these people and events -- treat names and descriptions as
needing a human check.
